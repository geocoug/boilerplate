...
class Data:
    ...
    def __init__(self: "Data", data: dict) -> None:
        """Object intialization."""
        self.df = pd.DataFrame(data)
        self.columns = list(self.df.columns)

    def add_dataframe_column(self: "Data", col_name: str) -> None:
        """Add a new dataframe column."""
        self.df[col_name] = np.nan

    def fill_dataframe_column(self: "Data", col_name: str, data: list) -> None:
